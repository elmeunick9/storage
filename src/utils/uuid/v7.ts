import { UUIDTypes, Version7Options } from './interfaces.ts'
...
// and may change without notice. Edit: Not anymore
function updateV7State(state: V7State, now: number, rnds: Uint8Array) {
